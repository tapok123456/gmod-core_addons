...
ENT.PrintName = "Albany Emperor"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/albany_emperor/albany_emperor.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/albany_emperor/albany_emperor.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/albany_emperor.png"
...
if CLIENT then
    ...
    ENT.ExhaustAlpha = 30
    ENT.ExhaustOffsets = {
        { pos = Vector( -122,-30,-13.5 ), angle = Angle( -40, 0, 0 ), scale = 2 },
    }
...
-- turn signals			
		--front
		{ type = "signal_left", offset = Vector( 99,40,4 ), dir = Vector( 0.8, 1, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        self:CreateWheel( Vector( 68,36,0 ), {
            model = "models/props_vehicles/lcp/wheel29.mdl",
