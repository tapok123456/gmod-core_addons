...
ENT.PrintName = "Albany Manana"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/albany_manana/albany_manana.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/albany_manana/albany_manana.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/albany_manana.png"
