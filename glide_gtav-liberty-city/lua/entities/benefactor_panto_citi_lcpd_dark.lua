...
ENT.PrintName = "Benefactor Panto Citi LCPD Dark"
ENT.GlideCategory = "LC - LCPD"
ENT.ChassisModel = "models/props_vehicles/lcp/benefactor_panto_citi/benefactor_panto_citi_lcpd.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/benefactor_panto_citi/benefactor_panto_citi_lcpd.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/benefactor_panto_citi_lcpd_dark.png"
...
-- turn signals			
    ...
    ENT.SirenLights = {
        -- (white) lights
        { offset = Vector( -13, 0, 57 ), time = 0, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -13, 0, 57 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_W },
        -- (red) lights
        { offset = Vector( -17, 8, 57 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -17, 8, 57 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -17, -8, 57 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -17, -8, 57 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -17, 8, 57 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -17, -8, 57 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A },
