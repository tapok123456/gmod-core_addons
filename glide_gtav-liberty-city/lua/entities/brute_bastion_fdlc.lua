...
ENT.PrintName = "Brute Bastion FDPD"
ENT.GlideCategory = "LC - FDLC"
ENT.ChassisModel = "models/props_vehicles/lcp/brute_bastion/brute_bastion_fdlc.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/brute_bastion/brute_bastion_fdlc.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/brute_bastion_fdlc.png"
...
-- turn signals			
    ...
    ENT.SirenLights = {
        -- lights
        { offset = Vector( 35, 5, 100 ), time = 0.25, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -5, 100 ), time = 0.25, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 5, 100 ), time = 0.5, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -5, 100 ), time = 0.5, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 15, 100 ), time = 0.75, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -15, 100 ), time = 0.75, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 15, 100 ), time = 0.0, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -15, 100 ), time = 0.0, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 24.5, 100 ), time = 0.25, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -24.5, 100 ), time = 0.25, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 24.5, 100 ), time = 0.5, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -24.5, 100 ), time = 0.5, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 33, 100 ), time = 0.75, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -33, 100 ), time = 0.75, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, 33, 100 ), time = 0.0, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
        { offset = Vector( 35, -33, 100 ), time = 0.0, color = Glide.DEFAULT_TURN_SIGNAL_COLOR },
