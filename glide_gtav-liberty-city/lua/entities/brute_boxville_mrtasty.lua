...
ENT.PrintName = "Brute Boxville Mr.Tasty"
ENT.GlideCategory = "LC - Services"
ENT.ChassisModel = "models/props_vehicles/lcp/brute_boxville/brute_boxville_mrtasty.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/brute_boxville/brute_boxville_mrtasty.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/brute_boxville_mrtasty.png"
