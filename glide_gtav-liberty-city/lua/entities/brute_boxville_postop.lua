...
ENT.PrintName = "Brute Boxville Post OP"
ENT.GlideCategory = "LC - Services"
ENT.ChassisModel = "models/props_vehicles/lcp/brute_boxville/brute_boxville.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/brute_boxville/brute_boxville.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/brute_boxville_postop.png"
...
if SERVER then
    ...
    function ENT:CreateFeatures()
		self:SetColor( Color( 90, 80, 60, 255 ) )
