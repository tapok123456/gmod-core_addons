...
ENT.PrintName = "Brute Refuser"
ENT.GlideCategory = "LC - Services"
ENT.ChassisModel = "models/props_vehicles/lcp/brute_refuser/brute_refuser.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/brute_refuser/brute_refuser.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/brute_refuser.png"
if CLIENT then
    ...
    ENT.CameraOffset = Vector( -660, 0, 120 )
    ENT.CameraAngleOffset = Angle( 5, 0, 0 )
    ENT.ExhaustAlpha = 60
    ENT.ExhaustOffsets = {
        { pos = Vector( 24, -57, 117 ), scale = 2 },
    }
	
    ENT.EngineSmokeStrips = {
        { offset = Vector( 174, 0, 5 ), angle = Angle( -20, 0, 0 ), width = 30 },
    }
    ...
    ENT.Headlights = {
        { offset = Vector( 170,45,6 ) },
        { offset = Vector( 170,-45,6 ) },
    }

    ENT.LightSprites = {
-- reverse lights
        { type = "reverse", offset = Vector( -233,29,86.5 ), dir = Vector( -1, 0, 0 ), size = 40, color = COLOR_REARLIGHT },
        { type = "reverse", offset = Vector( -233,-29,86.5 ), dir = Vector( -1, 0, 0 ), size = 40, color = COLOR_REARLIGHT },	
-- brake lights
        { type = "brake", offset = Vector( -292,32,-32 ), dir = Vector( -1, 0, 0 ), size = 60 },
        { type = "brake", offset = Vector( -292,-32,-32 ), dir = Vector( -1, 0, 0 ), size = 60 },             		
        { type = "brake", offset = Vector( -233,37,86.5 ), dir = Vector( -1, 0, 0 ), size = 60 },
        { type = "brake", offset = Vector( -233,-37,86.5 ), dir = Vector( -1, 0, 0 ), size = 60 },             		
-- rear lights 
		{ type = "taillight", offset = Vector( -292,41,-32 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50 },   
		{ type = "taillight", offset = Vector( -292,-41,-32 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50},	
		{ type = "taillight", offset = Vector( -233,44,86.5 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50 },   
		{ type = "taillight", offset = Vector( -233,-44,86.5 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50},	
-- headlights		
        { type = "headlight", offset = Vector( 170,45,6 ), dir = Vector( 1, 0, 0 ), size = 30 },
        { type = "headlight", offset = Vector( 170,-45,6 ), dir = Vector( 1, 0, 0 ), size = 30  },	
-- turn signals			
		--rear
		{ type = "signal_left", offset = Vector( -292,49,-32 ), dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
        { type = "signal_right", offset = Vector( -292,-49,-32 ), dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
    }
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        self:CreateSeat( Vector( 52,25,14 ), Angle( 0, -90, 0 ), Vector( 140.0,100,0 ), true )
		
        self:CreateSeat( Vector( 70, -25, 19 ), Angle( 0, -90, 18 ), Vector( 140.0,100,0 ), true )  		

        self:CreateWheel( Vector( 135,48,-15 ), {
        ...
        self:CreateWheel( Vector( -129,48,-15 ), {
        ...
        self:CreateWheel( Vector( -189,48,-15 ), {
            model = "models/props_vehicles/lcp/wheel28a.mdl",
            modelAngle = Angle( 0, 0, 0 ),
            modelScale = Vector( 1, 0.55, 1 ),
