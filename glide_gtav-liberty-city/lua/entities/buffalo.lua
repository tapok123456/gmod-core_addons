...
ENT.ChassisModel = "models/props_vehicles/lcp/buffalo/buffalo.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/buffalo/buffalo.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/buffalo.png"
