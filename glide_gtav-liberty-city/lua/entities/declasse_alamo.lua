...
ENT.PrintName = "Declasse Alamo"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/declasse_alamo/declasse_alamo.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/declasse_alamo/declasse_alamo.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/declasse_alamo.png"
if CLIENT then
