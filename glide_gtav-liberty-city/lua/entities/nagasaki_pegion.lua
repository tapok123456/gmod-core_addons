...
ENT.PrintName = "Nagasaki Pegion"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/nagasaki_pegion/nagasaki_pegion.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/nagasaki_pegion/nagasaki_pegion.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/nagasaki_pegion.png"
