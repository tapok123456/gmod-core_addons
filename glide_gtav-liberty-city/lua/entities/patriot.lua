...
ENT.ChassisModel = "models/props_vehicles/lcp/patriot/patriot.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/patriot/patriot.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/patriot.png"
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        self:CreateWheel( Vector( 76,39,-2.0 ), {
            model = "models/props_vehicles/lcp/wheel04.mdl",
