...
ENT.PrintName = "Romero Hearse"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/romero_hearse/romero_hearse.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/romero_hearse/romero_hearse.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/romero_hearse.png"

if CLIENT then
    ENT.HornSound = "glide/horns/car_horn_med_3.wav"
    ENT.CameraOffset = Vector( -310, 0, 50 )
    ENT.CameraAngleOffset = Angle( 5, 0, 0 )
    ENT.ExhaustAlpha = 20
    ENT.ExhaustOffsets = {
        { pos = Vector( -129,25,-13.5 ), scale = 2 },
    }

    ENT.EngineSmokeStrips = {
        { offset = Vector( 117, 0, 5 ), angle = Angle( -20, 0, 0 ), width = 35 },
    }

    ENT.EngineFireOffsets = {
        { offset = Vector( 117, 0, 5 ), angle = Angle( 0, 90, 0 ) }, 
    }

    ENT.Headlights = {
        { offset = Vector( 111,27,7.5 ) },
        { offset = Vector( 111,-27,7.5 ) },
    }

    ENT.LightSprites = {
-- reverse lights
        { type = "reverse", offset = Vector( -134,10,-7 ), dir = Vector( -1, 0, 0 ), size = 40, color = COLOR_REARLIGHT },
        { type = "reverse", offset = Vector( -134,-10,-7 ), dir = Vector( -1, 0, 0 ), size = 40, color = COLOR_REARLIGHT },	
-- brake lights
        { type = "brake", offset = Vector( -130,35,4 ), dir = Vector( -1, 0, 0 ), size = 60 },
        { type = "brake", offset = Vector( -130,-35,4 ), dir = Vector( -1, 0, 0 ), size = 60 },             		
-- rear lights 
		{ type = "taillight", offset = Vector( -130,35,11 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50 },   
		{ type = "taillight", offset = Vector( -130,-35,11 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50},	
-- headlights		
        { type = "headlight", offset = Vector( 111,27,7.5 ), dir = Vector( 1, 0, 0 ), size = 30 },
        { type = "headlight", offset = Vector( 111,-27,7.5 ), dir = Vector( 1, 0, 0 ), size = 30  },	
        { type = "headlight", offset = Vector( 107,33.5,8 ), dir = Vector( 1, 0, 0 ), size = 20 },
        { type = "headlight", offset = Vector( 107,-33.5,8 ), dir = Vector( 1, 0, 0 ), size = 20  },	
-- turn signals			
		--front
		{ type = "signal_left", offset = Vector( 110,32,4.5 ), dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
        { type = "signal_right", offset = Vector( 110,-32,4.5 ), dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
    }
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        self:CreateSeat( Vector( 6,22,-11 ), Angle( 0, -90, 0 ), Vector( 20.0,80,50 ), true )
		
        self:CreateSeat( Vector( 22, -22, -9 ), Angle( 0, -90, 18 ), Vector( 20.0,-80,50 ), true )       

        self:CreateWheel( Vector( 81,36,0 ), {
            model = "models/props_vehicles/lcp/wheel31.mdl",
        ...
        self:CreateWheel( Vector( -83,36,0 ), {
            model = "models/props_vehicles/lcp/wheel31.mdl",
            modelAngle = Angle( 0, 0, 0 ),
            modelScale = Vector( 1, 0.35, 1 ),
