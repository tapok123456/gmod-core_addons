...
ENT.ChassisModel = "models/props_vehicles/lcp/seashark/seashark.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/seashark/seashark.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/seashark.png"
