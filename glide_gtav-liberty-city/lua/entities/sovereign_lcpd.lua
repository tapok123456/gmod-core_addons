...
ENT.PrintName = "Sovereign LCPD"
ENT.GlideCategory = "LC - LCPD"
ENT.ChassisModel = "models/props_vehicles/lcp/sovereign/sovereign_lcpd.mdl"
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/sovereign_lcpd.png"
...
if CLIENT then
    ENT.CameraOffset = Vector( -190, 0, 50 )
    ENT.StartSound = "Glide.Engine.BikeStart2"
    ENT.WheelSkidmarkScale = 0.45

    ENT.ExhaustOffsets = {
        { pos = Vector( -57, 8.5, -12 ), scale = 1 },
        { pos = Vector( -57, -8.5, -12 ), scale = 1 }
    }

    ENT.EngineSmokeStrips = {
        { offset = Vector( 0, 0, -2 ), angle = Angle( 40, 180, 0 ), width = 15 }
    }

    ENT.EngineFireOffsets = {
        { offset = Vector( 0, 5, -2 ), angle = Angle( 90, 90, 0 ), scale = 0.4 },
        { offset = Vector( 0, -5, -2 ), angle = Angle( 90, 270, 0 ), scale = 0.4 }
    }

    ENT.LightSprites = {
-- brake lights
        { type = "brake", offset = Vector( -54, 0, 15.5 ), dir = Vector( -1, 0, 0 ), size = 60 },
-- rear lights 
		{ type = "taillight", offset = Vector( -54, 0, 12 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50 },   
-- headlights		
        { type = "headlight", offset = Vector( 32, 0, 17 ), dir = Vector( 1, 0, 0 ), size = 30 },
-- turn signals			
		--front
		{ type = "signal_left", offset = Vector( 28, 9.5, 9 ), dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
        { type = "signal_right", offset = Vector( 28, -9.5, 9 ), dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
		--rear
		{ type = "signal_left", offset = Vector( -51, 12.5, 1.5 ), dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
        { type = "signal_right", offset = Vector( -51, -12.5, 1.5 ), dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
    }
    ENT.SirenLights = {
        -- (blue) lights
		
        { offset = Vector( -46, 7, 31.5 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_B },
        { offset = Vector( -46, 7, 31.5 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_B },

        { offset = Vector( -53, 7.5, 2.5 ), time = 0.25, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },
        { offset = Vector( -53, 7.5, 2.5 ), time = 0.5, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },
        { offset = Vector( -53, -7.5, 2.5 ), time = 0.75, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },
        { offset = Vector( -53, -7.5, 2.5 ), time = 0.0, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },

        { offset = Vector( -51, -12.5, -4 ), time = 0.25, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },
        { offset = Vector( -51, -12.5, -4 ), time = 0.5, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },

        { offset = Vector( 28, -9.5, 13 ), time = 0.25, dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },
        { offset = Vector( 28, -9.5, 13 ), time = 0.5, dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_B },

        -- (red) lights
        { offset = Vector( -46, -7, 31.5 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -46, -7, 31.5 ), time = 0.0, color = Glide.DEFAULT_SIREN_COLOR_A },

        { offset = Vector( -51, 12.5, -4 ), time = 0.75, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -51, 12.5, -4 ), time = 0.0, dir = Vector( -1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_A },

        { offset = Vector( 28, 9.5, 13 ), time = 0.75, dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( 28, 9.5, 13 ), time = 0.0, dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_SIREN_COLOR_A },
    ...
    ENT.Headlights = {
        { offset = Vector( 32, 0, 17 ), texture = "glide/effects/headlight_circle2" }
    }
    ...
    local DRIVER_POSE_DATA = {
        ["ValveBiped.Bip01_L_UpperArm"] = Angle( -10, 10, -15 ),
        ["ValveBiped.Bip01_R_UpperArm"] = Angle( 10, 5, 25 ),
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        -- Front
        self:CreateWheel( Vector( 38, 0, -1 ), {
            steerMultiplier = 1
        } )
