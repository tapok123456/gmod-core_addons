...
ENT.PrintName = "Vapid Benson"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/vapid_benson/vapid_benson.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/vapid_benson/vapid_benson.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_benson.png"
if CLIENT then
    ...
    ENT.ExhaustAlpha = 60
    ENT.ExhaustOffsets = {
        { pos = Vector( -55, 18, -31 ), angle = Angle( -30, -30, 0 ), scale = 2 },
    }
	
    ENT.EngineSmokeStrips = {
        { offset = Vector( 182, 0, -4 ), angle = Angle( -20, 0, 0 ), width = 55 },
    }

    ENT.EngineFireOffsets = {
        { offset = Vector( 182, 0, -4 ), angle = Angle( 0, 90, 0 ) }, 
    }

    ENT.Headlights = {
        { offset = Vector( 179,46,-6.5 ) },
        { offset = Vector( 179,-46,-6.5 ) },
    }

    ENT.LightSprites = {
-- reverse lights
        { type = "reverse", offset = Vector( -240,57,27 ), dir = Vector( -1, 0, 0 ), size = 40, color = COLOR_REARLIGHT },
        { type = "reverse", offset = Vector( -240,-57,27 ), dir = Vector( -1, 0, 0 ), size = 40, color = COLOR_REARLIGHT },	
-- brake lights
        { type = "brake", offset = Vector( -240,57,35 ), dir = Vector( -1, 0, 0 ), size = 60 },
        { type = "brake", offset = Vector( -240,-57,35 ), dir = Vector( -1, 0, 0 ), size = 60 },             		
-- rear lights 
		{ type = "taillight", offset = Vector( -240,57,90 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50 },   
		{ type = "taillight", offset = Vector( -240,-57,90 ), dir = Vector( -1, 0, 0 ), color = COLOR_REARLIGHT, size = 50},	
-- headlights		
        { type = "headlight", offset = Vector( 179,46,-6.5 ), dir = Vector( 1, 0, 0 ), size = 30 },
        { type = "headlight", offset = Vector( 179,-46,-6.5 ), dir = Vector( 1, 0, 0 ), size = 30  },	
-- turn signals			
		--front
		{ type = "signal_left", offset = Vector( 171,48,8 ), dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
        { type = "signal_right", offset = Vector( 171,-48,8 ), dir = Vector( 1, 0, 0 ), color = Glide.DEFAULT_TURN_SIGNAL_COLOR, size = 40 },
    }
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        self:CreateSeat( Vector( 68,25,4 ), Angle( 0, -90, 0 ), Vector( 140.0,100,0 ), true )
		
        self:CreateSeat( Vector( 86, -25, 8 ), Angle( 0, -90, 18 ), Vector( 140.0,100,0 ), true )  		

        self:CreateWheel( Vector( 145,49,-15 ), {
        ...
        self:CreateWheel( Vector( -150,57,-15 ), {
