...
ENT.PrintName = "Vapid Riata Classic LCPD Dark"
ENT.GlideCategory = "LC - LCPD"
ENT.ChassisModel = "models/props_vehicles/lcp/vapid_riata_classic/vapid_riata_classic_lcpd.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/vapid_riata_classic/vapid_riata_classic_lcpd.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_riata_classic_lcpd_dark.png"
...
-- turn signals			
    ...
    ENT.SirenLights = {
        -- (red) lights
        { offset = Vector( 10, 14, 61 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( 10, -14, 61 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( 10, 14, 61 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( 10, -14, 61 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },

        -- (white) lights
        { offset = Vector( 10, 25, 61 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( 10, -25, 61 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( 10, 25, 61 ), time = 0.0, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( 10, -25, 61 ), time = 0.0, color = Glide.DEFAULT_SIREN_COLOR_W },
