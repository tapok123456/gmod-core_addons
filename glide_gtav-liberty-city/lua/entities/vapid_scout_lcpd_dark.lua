...
ENT.PrintName = "Vapid Scout LCPD Dark"
ENT.GlideCategory = "LC - LCPD"
ENT.ChassisModel = "models/props_vehicles/lcp/vapid_scout/vapid_scout_lcpd.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/vapid_scout/vapid_scout_lcpd.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_scout_lcpd_dark.png"
...
-- turn signals			
    ...
    ENT.SirenLights = {
        -- (white) lights
        { offset = Vector( 0.5, 0, 46 ), time = 0.0, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( 0.5, 0, 46 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -15.5, 9.5, 46 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -15.5, 9.5, 46 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -15.5, -9.5, 46 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -15.5, -9.5, 46 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_W },
        -- (red) lights
        { offset = Vector( -4, 7.5, 46 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -4, 7.5, 46 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -4, -7.5, 46 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -4, -7.5, 46 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -12, 23, 46 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -12, 23, 46 ), time = 1.0, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -12, -23, 46 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -12, -23, 46 ), time = 1.0, color = Glide.DEFAULT_SIREN_COLOR_A },

        -- (red) front

        { offset = Vector( 96, 12, 0 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        { offset = Vector( 96, -12, 0 ), time = 0.25, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        { offset = Vector( 96, 12, 0 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        { offset = Vector( 96, -12, 0 ), time = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        { offset = Vector( 96, 12, 0 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        { offset = Vector( 96, -12, 0 ), time = 0.75, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        -- (red) back/blue

        { offset = Vector( -105, 19.5, 32.5 ), time = 0.0, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( -1, 0, 0 ) },
        { offset = Vector( -105, -19.5, 32.5 ), time = 0.0, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( -1, 0, 0 ) },
        { offset = Vector( -105.5, 15.5, 32.5 ), time = 0.5, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_B, dir = Vector( -1, 0, 0 ) },
        { offset = Vector( -105.5, -15.5, 32.5 ), time = 0.5, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_B, dir = Vector( -1, 0, 0 ) },
