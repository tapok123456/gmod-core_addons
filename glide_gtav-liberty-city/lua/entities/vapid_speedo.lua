...
ENT.PrintName = "Vapid Speedo"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/speedo/speedo.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/speedo/speedo.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_speedo.png"
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        ...
        self:CreateSeat( Vector( 9, 23, -3 ), Angle( 0, -90, 0 ), Vector( 30.0,80,50 ), true )
