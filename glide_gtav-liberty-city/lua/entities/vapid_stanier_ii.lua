...
ENT.PrintName = "Vapid Stanier II"
ENT.GlideCategory = "LC"
ENT.ChassisModel = "models/props_vehicles/lcp/vapid_stanier_ii/vapid_stanier_ii.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/vapid_stanier_ii/vapid_stanier_ii.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_stanier_ii.png"
...
if SERVER then
    ...
    ENT.LightBodygroups = {
        ...
        { type = "headlight", bodyGroupId = 6, subModelId = 1 }, -- Tail light left

        { type = "brake", bodyGroupId = 5, subModelId = 1 },
