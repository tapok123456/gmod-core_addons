...
ENT.PrintName = "Vapid Stanier II FDLC"
ENT.GlideCategory = "LC - FDLC"
ENT.ChassisModel = "models/props_vehicles/lcp/vapid_stanier_ii/vapid_stanier_ii_fdlc.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/vapid_stanier_ii/vapid_stanier_ii_fdlc.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_stanier_ii_fdlc.png"
...
-- turn signals			
    ...
    ENT.SirenLights = {
        -- (white) lights
        { offset = Vector( -12, 18, 43 ), time = 0.5, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -12, -18, 43 ), time = 0.5, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -12, 3, 43 ), time = 0.5, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_W },
        { offset = Vector( -12, -3, 43 ), time = 0.5, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_W },

        -- (red) lights
        { offset = Vector( -12, 9, 43 ), time = 0.0, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },
        { offset = Vector( -12, -9, 43 ), time = 0.0, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A },

        { offset = Vector( 115, 9, 4.5 ), time = 0.0, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },
        { offset = Vector( 115, -9, 4.5 ), time = 0.0, duration = 0.5, color = Glide.DEFAULT_SIREN_COLOR_A, dir = Vector( 1, 0, 0 ) },

        { bodygroup = 13, time = 0.5, duration = 0.5 },
        { bodygroup = 14, time = 0, duration = 0.5 },
        { bodygroup = 15, time = 0.5, duration = 0.5 },
