...
ENT.PrintName = "Vapid Stanier II LC Taxi"
ENT.GlideCategory = "LC - Services"
ENT.ChassisModel = "models/props_vehicles/lcp/vapid_stanier_ii/vapid_stanier_ii_lctaxi.mdl"
ENT.ExplosionGibs = { "models/props_vehicles/lcp/vapid_stanier_ii/vapid_stanier_ii_lctaxi.mdl" }
ENT.Author = "Exidnost"
ENT.IconOverride = "gui/glide/lcp/vapid_stanier_ii_lctaxi.png"
