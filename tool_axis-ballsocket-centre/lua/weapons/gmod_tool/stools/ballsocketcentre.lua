...
TOOL.Name = "#tool.ballsocketcentre.listname"
TOOL.Command = nil
TOOL.ConfigName = nil
...
if CLIENT then
	language.Add("tool.ballsocketcentre.name","Centre Ball Socket Constraint")
	language.Add("tool.ballsocketcentre.listname","Ball Socket - Centre")
	language.Add("tool.ballsocketcentre.desc", "Ball socket props by centre of mass" )
	language.Add("tool.ballsocketcentre.0", "Left Click: Select prop to ball socket." )
	language.Add("tool.ballsocketcentre.1", "Left Click: Select base prop to ball socket to." )
	language.Add("tool.ballsocketcentre.nocollide", "Nocollide" )
	language.Add("tool.ballsocketcentre.simpleballsocket", "Simple Ball Socket (ignore adv settings)" )
	language.Add("tool.ballsocketcentre.rotationonly", "Rotation Constraint" )
	language.Add("tool.ballsocketcentre.moveprop", "Move first prop (remember to nocollide!)" )
	language.Add("Undone_Ballsocket Centre","Undone Ball Socket Centre")
	language.Add("Undone_Rotation Constraint","Undone Rotation Constraint")
...
function TOOL.BuildCPanel( Panel )
	...
	Panel:AddControl("Header",{Text = "#tool.ballsocketcentre.name", Description	= "#tool.ballsocketcentre.desc"})	
	Panel:AddControl("CheckBox",{Label = "#tool.ballsocketcentre.nocollide", Description = "", Command = "ballsocketcentre_nocollide"})
	Panel:AddControl("CheckBox",{Label = "#tool.ballsocketcentre.moveprop", Description = "Move prop so both centres overlap", Command = "ballsocketcentre_moveprop"})
	Panel:AddControl("CheckBox",{Label = "#tool.ballsocketcentre.simpleballsocket", Description = "Create a simple ballsocket with no angle limits", Command = "ballsocketcentre_simpleballsocket"})
	Panel:AddControl("CheckBox",{Label = "#tool.ballsocketcentre.rotationonly", Description = "Creates 3 separate X/Y/Z ballsockets to match rotation between the two constrained entities", Command = "ballsocketcentre_rotationonly"})
